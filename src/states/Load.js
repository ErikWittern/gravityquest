...
class LoadState extends Phaser.State {
  ...
  preload() {
    ...
    this.load.bitmapFont(
      'font_white_12',
      './assets/fonts/font_white_12.png',
      './assets/fonts/font_white_12' + (navigator.isCocoonJS ? '.json' : '.fnt')
    );
    this.load.bitmapFont(
      'font_white_16',
      './assets/fonts/font_white_16.png',
      './assets/fonts/font_white_16' + (navigator.isCocoonJS ? '.json' : '.fnt')
    );
    this.load.bitmapFont(
      'font_white_24',
      './assets/fonts/font_white_24.png',
      './assets/fonts/font_white_24' + (navigator.isCocoonJS ? '.json' : '.fnt')
    );
    this.load.bitmapFont(
      'font_white_32',
      './assets/fonts/font_white_32.png',
      './assets/fonts/font_white_32' + (navigator.isCocoonJS ? '.json' : '.fnt')
    );

    this.load.bitmapFont(
      'font_black_8',
      './assets/fonts/font_black_8.png',
      './assets/fonts/font_black_8' + (navigator.isCocoonJS ? '.json' : '.fnt')
    );
    this.load.bitmapFont(
      'font_black_12',
      './assets/fonts/font_black_12.png',
      './assets/fonts/font_black_12' + (navigator.isCocoonJS ? '.json' : '.fnt')
    );
    this.load.bitmapFont(
      'font_black_16',
      './assets/fonts/font_black_16.png',
      './assets/fonts/font_black_16' + (navigator.isCocoonJS ? '.json' : '.fnt')
    );
    ...
    this.load.image(
      'thermoAsteroid_32',
      './assets/images/thermoAsteroid_32.png'
    );
    this.load.image(
      'thermoAsteroid_64',
      './assets/images/thermoAsteroid_64.png'
    );
    this.load.spritesheet(
      'antiForceField_64',
      './assets/images/antiForceField_64.png',
      32,
      32
    );
    this.load.spritesheet(
      'antiForceField_96',
      './assets/images/antiForceField_96.png',
      48,
      48
    );
    ...
    this.load.image(
      'speechBubbleRadio',
      './assets/images/speechBubbleRadio.png'
    );
    ...
    this.load.audio(
      'shuttle_explosion',
      './assets/sounds/shuttle_explosion.mp3'
    );
    // Javolenus featuring Nickleus - "C95 - Routine Maintenance Mission"
    this.load.audio(
      'C95',
      './assets/sounds/Javolenus_-_C95-RoutineMaintenanceMission.mp3'
    );
    // Karsten Holy Moly - "Space Intro"
    this.load.audio(
      'space_intro',
      './assets/sounds/Karstenholymoly_-_Space_Intro.mp3'
    );
